...
namespace MusicHub.Controllers
{
    public class WritersController : Controller
    {
        ...
        public WritersController(MusicHubContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Pseudonym")] Writer writer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Pseudonym")] Writer writer)
        {
            if (id != writer.Id)
            {
                return NotFound();
